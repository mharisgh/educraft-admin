// Get the elements
const addWhatsNewBtn = document.getElementById('addWhatsNewBtn');
const whatsnewAddPopup = document.getElementById('whatsnewAddPopup');
const closeWhatsNewPostPopupBtn = document.querySelectorAll('.close-whatsnew-post-popup-btn');

addWhatsNewBtn.addEventListener('click', () => {
  whatsnewAddPopup.classList.toggle('hidden');
  whatsnewAddPopup.classList.toggle('flex');
})

closeWhatsNewPostPopupBtn.forEach(btn => {
